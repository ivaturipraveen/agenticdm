...
const SCENARIOS = [
  { value: 'FUM_CLOSED', label: 'FUM — ED → BH follow-up (7-day)' },
  { value: 'FUA_CLOSED', label: 'FUA — ED → AOD follow-up' },
  { value: 'CBP_CONTROLLED', label: 'CBP — BP controlled' },
  { value: 'HBD_CONTROLLED', label: 'HBD — HbA1c controlled' },
  { value: 'MRP_CLOSED', label: 'MRP — medication reconciliation' },
]
  ...
  return (
    <div className="p-8 max-w-[1500px] mx-auto">
      <div className="mb-6 flex items-center justify-between gap-4 flex-wrap">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Raw CDA vs Extracted Data</h1>
          <p className="text-sm text-slate-500 mt-1">The killer comparison: intimidating XML on the left → clean clinical facts on the right.</p>
        </div>
        <select
          value={scenario}
